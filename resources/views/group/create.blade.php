...
@section('content')
    <div class="min-h-screen bg-gray-50 py-8" dir="rtl">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <nav class="flex space-x-reverse space-x-4">
                    ...
                    <a href="{{ route('group.index') }}"
                       class="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
                        <svg class="inline h-4 w-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">إضافة مجموعة جديدة</h1>
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-reverse space-x-4">
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="text-gray-500">إضافة مجموعة</span>
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg">
                <form method="post" action="{{route('group.store')}}" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name"
                               ...
                               value="{{ old('name') }}" placeholder="أدخل اسم المجموعة">
                        @error('name')
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                                  ...
                                  placeholder="أدخل وصف المجموعة (اختياري)">{{ old('description') }}</textarea>
                        @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="capacity" id="capacity"
                               ...
                               value="{{ old('capacity', 30) }}" placeholder="أدخل سعة المجموعة" min="1" max="100">
                        @error('capacity')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="level" id="level"
                            ...
                            <option value="الصف الأول الابتدائي" @selected(old('level') == 'الصف الأول الابتدائي')>الصف الأول الابتدائي</option>
                            <option value="الصف الثاني الابتدائي" @selected(old('level') == 'الصف الثاني الابتدائي')>الصف الثاني الابتدائي</option>
                            <option value="الصف الثالث الابتدائي" @selected(old('level') == 'الصف الثالث الابتدائي')>الصف الثالث الابتدائي</option>
                            <option value="الصف الرابع الابتدائي" @selected(old('level') == 'الصف الرابع الابتدائي')>الصف الرابع الابتدائي</option>
                            <option value="الصف الخامس الابتدائي" @selected(old('level') == 'الصف الخامس الابتدائي')>الصف الخامس الابتدائي</option>
                            <option value="الصف السادس الابتدائي" @selected(old('level') == 'الصف السادس الابتدائي')>الصف السادس الابتدائي</option>
                            <option value="الصف الأول الإعدادي" @selected(old('level') == 'الصف الأول الإعدادي')>الصف الأول الإعدادي</option>
                            <option value="الصف الثاني الإعدادي" @selected(old('level') == 'الصف الثاني الإعدادي')>الصف الثاني الإعدادي</option>
                            <option value="الصف الثالث الإعدادي" @selected(old('level') == 'الصف الثالث الإعدادي')>الصف الثالث الإعدادي</option>
                            <option value="الصف الأول الثانوي" @selected(old('level') == 'الصف الأول الثانوي')>الصف الأول الثانوي</option>
                            <option value="الصف الثاني الثانوي" @selected(old('level') == 'الصف الثاني الثانوي')>الصف الثاني الثانوي</option>
                            <option value="الصف الثالث الثانوي" @selected(old('level') == 'الصف الثالث الثانوي')>الصف الثالث الثانوي</option>
                        </select>
                        @error('level')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="section" id="section"
                               ...
                               value="{{ old('section') }}" placeholder="أدخل الشعبة (مثل: أ، ب، ج - اختياري)">
                        @error('section')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
